---
title: "How do I give my AI coding agent long-term memory of past decisions across sessions?"
description: "Selvedge stores recorded code decisions and rejected approaches in local SQLite so agents can retrieve the reasons in later sessions."
structuredData:
  type: techarticle
  faq:
