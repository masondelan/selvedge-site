  ...
  faq:
    ...
    - question: Can I export the trail to other tools?
      answer: >-
        ...
        open format for AI code attribution from Cursor and Cognition, so the
